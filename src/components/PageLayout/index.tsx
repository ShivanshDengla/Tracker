...
const Header = (props: { children: ReactNode; className?: string }) => {
  return (
    <header
      className={twMerge(
        'bg-white flex flex-col justify-center px-4 sm:px-6 pt-6 pb-3 z-10',
...
const Main = (props: { children: ReactNode; className?: string }) => {
  return (
    <main
      className={twMerge(
        clsx('grow overflow-y-auto p-4 sm:p-6 pt-3', props.className),
      )}
    >
      {props.children}
    </main>
...
const Footer = (props: { children: ReactNode; className?: string }) => {
  return (
    <footer className={twMerge('px-4 sm:px-6 pb-[35px]', clsx(props.className))}>
      {props.children}
    </footer>
  );
};
