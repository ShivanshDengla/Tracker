  ...
  return (
    <div className="rounded-xl border border-zinc-200 bg-white px-3 py-2 flex items-center justify-between">
      <div className="min-w-0 flex-1">
        ...
        <div className="text-sm font-mono text-zinc-800 truncate">
      ...
      <button
        ...
        className="text-xs px-2 py-1 rounded-md border border-zinc-200 text-zinc-700 hover:bg-zinc-50 disabled:opacity-50 bg-blue-50 flex-shrink-0 ml-2"
        disabled={isMyWallet}
        title={isMyWallet ? 'Already showing your wallet' : 'Switch to my wallet'}
      >
        <span className="hidden sm:inline">Switch to My Wallet</span>
        <span className="sm:hidden">My Wallet</span>
      </button>
    </div>
  );
};
